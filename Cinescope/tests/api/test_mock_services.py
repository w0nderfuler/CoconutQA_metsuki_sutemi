...
class TestTodayIsHolidayServiceAPI:
    ...
    def test_what_is_today_BY_MOCK(self, mocker):
        ...
        mocker.patch(
            "Cinescope.tests.api.test_mock_services.get_worldclockap_time",
        ...
        print(what_is_today_response.status_code)
        print(what_is_today_response.text)
    ...
    def test_what_is_today_BY_STUB(self, monkeypatch):
            ...
            monkeypatch.setattr("Cinescope.tests.api.test_mock_services.get_worldclockap_time", self.stub_get_worldclockap_time)
