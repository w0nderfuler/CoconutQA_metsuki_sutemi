...
from Cinescope.resources.models.movie_model import MovieModel, MoviesResponseModel
import pytest
import allure
...
class TestSuperAdminMethodsPositive:
    ...
    def test_get(self, super_admin):  # список фильмов
        ...
        response_data = MoviesResponseModel.model_validate(response.json())
    ...
    def test_post(self, super_admin):  # создание фильма
        ...
        response_data = MovieModel.model_validate(response.json())
...
@allure.epic("Тестирование методов ендпоинта movies")
@allure.feature("Негативные проверки SUPER_ADMIN")
...
class TestSuperAdminMethodsNegative:
    ...
    def test_get_invalid_params(self, super_admin):
        with allure.step("Создание некорректных фильтров"):
            invalid_page = MovieData.invalid_movie_id()
...
@allure.epic("Тестирование методов ендпоинта movies")
@allure.feature("Негативные проверки USER")
@allure.story("Корректность обработки ошибок при использовании методов")
@allure.description("Использование метода post")
@allure.severity(allure.severity_level.CRITICAL)
@allure.label("QA", "metsuki_sutemi")
...
@allure.epic("Тестирование методов ендпоинта movies")
@allure.feature("Проверки роли ADMIN")
